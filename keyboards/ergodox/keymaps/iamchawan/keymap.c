...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(
    ...
    LT(1,KC_GRAVE), KC_QUOTE,     KC_LALT, KC_UP,  KC_DOWN,

                KC_QUOTE,   KC_GRAVE,
                            KC_CAPS,
    KC_LGUI,    KC_SPACE,   KC_LANG2,

    KC_RIGHT,     KC_6,         KC_7,       KC_8,     KC_9,         KC_0,             KC_LSHIFT,
    TG(2),        KC_Y,         KC_U,       KC_I,     KC_O,         KC_P,             KC_BSLS,
                  KC_H,         KC_J,       KC_K,     KC_L,         LT(2,KC_SCOLON),  KC_EQL,
    MEH_T(KC_NO), KC_N,         KC_M,       KC_COMMA, KC_DOT,       CTL_T(KC_SLASH),  KC_MINUS,
                                KC_LEFT,    KC_RIGHT, KC_LBRACKET,  KC_RBRACKET,      MO(1),
  ...
  [1] = KEYMAP(
    ...
    KC_BTN1,KC_BTN2,KC_EQUAL,KC_TRANSPARENT,KC_TRANSPARENT,
